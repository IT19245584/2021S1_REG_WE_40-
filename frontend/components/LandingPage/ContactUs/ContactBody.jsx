                            ...
                            <div className="col">
                                <div className="card h-100 border border-dark mb-3">
                                    <div className="card-body">
                                        ...
                                        <email className="card-text" style={{display: 'flex',  justifyContent:'center', alignItems:'center'}}>info@sliit.lk</email>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row row-cols-1 row-cols-md-2 g-4">
                        <div className="col">
                            ...
                            <form>
                                ...
                                <div className="form-outline mb-4">
                                   Email: <input type="email" id="form4Example2" className="form-control border border-dark mb-3" required/>
                                   
                                </div>
                                <div className="form-outline mb-4">
                                   Subject: <input type="text" className="form-control border border-dark mb-3" id="form4Example3"/>
                                    
                                </div> 
                                <div className="form-outline mb-4">
                                    Message: <textarea className="form-control border border-dark mb-3" id="form4Example4" rows="4" required/>
