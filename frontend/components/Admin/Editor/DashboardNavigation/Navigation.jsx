    ...
    render() {
        return (
            <div className="d-flex p-2" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100px' }}>
                <button type="button" class="btn btn-outline-danger"><a href='/vieworg'>Organizing Committee</a></button>
                <button type="button" class="btn btn-outline-danger"><a href='/viewtech'>Technical Committee</a></button>
                ...
                <button type="button" class="btn btn-outline-danger"><a href='/viewpast'>Past Proceeding</a></button>
                <button type="button" class="btn btn-outline-danger"><a href='/viewaboutus'>About Us</a></button>
            </div>
        );
    }
}
